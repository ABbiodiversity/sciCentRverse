...
the
[`wt_download_report()`](https://abbiodiversity.github.io/wildrtrax/reference/wt_download_report.html)
function from wildrtrax.
...
```
    ...
    #> # A tibble: 10 × 6
    #>    project_id project                  location_id location date       operating
    #>         <int> <chr>                          <int> <chr>    <date>     <lgl>    
    #>  1       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-02-25 TRUE     
    #>  2       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-02-26 TRUE     
    #>  3       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-02-27 TRUE     
    #>  4       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-02-28 TRUE     
    #>  5       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-03-01 TRUE     
    #>  6       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-03-02 TRUE     
    #>  7       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-03-03 TRUE     
    #>  8       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-03-04 TRUE     
    #>  9       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-03-05 TRUE     
    #> 10       2025 Biodiversity Trajectori…      480691 OG-ALPA… 2023-03-06 TRUE
...
```
    ...
    #> # A tibble: 10 × 8
    #>    project       project_id location location_id spring summer winter total_days
    #>    <chr>              <int> <chr>          <int>  <int>  <int>  <int>      <int>
    #>  1 Biodiversity…       2025 OG-ALPA…      481310     43     52     17        112
    #>  2 Biodiversity…       2025 OG-ALPA…      480732     43     52     17        112
    #>  3 Biodiversity…       2025 OG-ALPA…      480731     43     52     17        112
    #>  4 Biodiversity…       2025 OG-ALPA…      480730     43     52     17        112
    #>  5 Biodiversity…       2025 OG-ALPA…      481252     43     52     24        119
    #>  6 Biodiversity…       2025 OG-ALPA…      480726     43     52     24        119
    #>  7 Biodiversity…       2025 OG-ALPA…      481251     43     52     24        119
    #>  8 Biodiversity…       2025 OG-ALPA…      480727     43     52     24        119
    #>  9 Biodiversity…       2025 OG-ALPA…      481250     43     53     15        111
    #> 10 Biodiversity…       2025 OG-ALPA…      480728     43     53     15        111
...
```
    ...
    #> # A tibble: 10 × 8
    #>    project    location species_common_name series_num n_images series_total_time
    #>    <chr>      <chr>    <chr>                    <int>    <int>             <dbl>
    #>  1 Biodivers… OG-ALPA… Black Bear                   1      150             982. 
    #>  2 Biodivers… OG-ALPA… Black Bear                   2       54             317. 
    #>  3 Biodivers… OG-ALPA… Black Bear                   3       32             178. 
    #>  4 Biodivers… OG-ALPA… Black Bear                   4       27             130. 
    #>  5 Biodivers… OG-ALPA… Black Bear                   5       45             611. 
    #>  6 Biodivers… OG-ALPA… Black Bear                   6       50             328. 
    #>  7 Biodivers… OG-ALPA… Black Bear                   7       11              41.2
    #>  8 Biodivers… OG-ALPA… Black Bear                   8       47             241. 
    #>  9 Biodivers… OG-ALPA… Black Bear                   9       20              80.2
    #> 10 Biodivers… OG-ALPA… Black Bear                  10       12              18.2
    #> # ℹ 2 more variables: series_start <dttm>, series_end <dttm>
...
```
    ...
    #> # A tibble: 10 × 9
    #>    project         location species_common_name season total_duration project_id
    #>    <chr>           <chr>    <chr>               <ord>           <dbl>      <int>
    #>  1 Biodiversity T… OG-ALPA… Black Bear          spring          3770.       2025
    #>  2 Biodiversity T… OG-ALPA… Black Bear          summer           170.       2025
    #>  3 Biodiversity T… OG-ALPA… Black Bear          winter             0        2025
    #>  4 Biodiversity T… OG-ALPA… Canada Lynx         spring             0        2025
    #>  5 Biodiversity T… OG-ALPA… Canada Lynx         summer             0        2025
    #>  6 Biodiversity T… OG-ALPA… Canada Lynx         winter             0        2025
    #>  7 Biodiversity T… OG-ALPA… Coyote              spring             0        2025
    #>  8 Biodiversity T… OG-ALPA… Coyote              summer             0        2025
    #>  9 Biodiversity T… OG-ALPA… Coyote              winter             0        2025
    #> 10 Biodiversity T… OG-ALPA… Fisher              spring             0        2025
    #> # ℹ 3 more variables: location_id <int>, total_days <int>,
    #> #   total_season_days <int>
...
```
    ...
    #> # A tibble: 10 × 7
    #>    project            location species_common_name overall_category model height
    #>    <chr>              <chr>    <chr>               <chr>            <chr> <chr> 
    #>  1 Biodiversity Traj… OG-ALPA… Black Bear          Forested_Open-O… hf2   high  
    #>  2 Biodiversity Traj… OG-ALPA… Canada Lynx         Forested_Open-O… hf2   high  
    #>  3 Biodiversity Traj… OG-ALPA… Coyote              Forested_Open-O… hf2   high  
    #>  4 Biodiversity Traj… OG-ALPA… Fisher              Forested_Open-O… hf2   high  
    #>  5 Biodiversity Traj… OG-ALPA… Marten              Forested_Open-O… hf2   high  
    #>  6 Biodiversity Traj… OG-ALPA… Moose               Forested_Open-O… hf2   high  
    #>  7 Biodiversity Traj… OG-ALPA… Snowshoe Hare       Forested_Open-O… hf2   high  
    #>  8 Biodiversity Traj… OG-ALPA… White-tailed Deer   Forested_Open-O… hf2   high  
    #>  9 Biodiversity Traj… OG-ALPA… Woodland Caribou    Forested_Open-O… hf2   high  
    #> 10 Biodiversity Traj… OG-ALPA… Black Bear          Shrubby_Closed   hf2   high  
    #> # ℹ 1 more variable: density_km2 <dbl>
